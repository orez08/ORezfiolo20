          ...
          >
            ...
            <div className="space-y-3 pt-2">
              ...
              <a
                ...
                className="group p-4 rounded-sm glass-surface border border-white/14 hover:border-[#25D366] hover:bg-[#25D366]/5 flex items-center justify-between transition-all"
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-10 h-10 rounded-full bg-[#25D366]/15 border border-[#25D366]/30 flex items-center justify-center text-[#25D366] group-hover:bg-[#25D366] group-hover:text-black transition-colors shadow-sm">
                  ...
                  <div>
                    <div className="text-[10px] font-sans uppercase tracking-widest text-[#25D366] font-semibold flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#25D366] animate-pulse" />
                      Instant WhatsApp Chat
                    </div>
                    <div className="text-sm font-medium text-white group-hover:text-[#25D366] transition-colors">

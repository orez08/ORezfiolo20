      ...
      >
        ...
        >
          ...
          <motion.a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full glass-surface border border-white/20 text-white font-semibold text-sm uppercase tracking-wider hover:border-[#25D366] hover:text-[#25D366] transition-all duration-300 shadow-lg group backdrop-blur-md"
          >

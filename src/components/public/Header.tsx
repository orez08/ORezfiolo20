        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full glass-surface border border-white/20 text-white hover:border-[#25D366] hover:text-[#25D366] transition-all text-xs font-sans uppercase font-semibold tracking-wider backdrop-blur-md shadow-md group hover:scale-105 active:scale-95"
            >

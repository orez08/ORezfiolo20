  ...
  return (
    <form onSubmit={handleSave} className="space-y-8 max-w-4xl">
      ...
      <div className="bg-[#181818] p-6 rounded-sm border border-[#F5F1EA]/10 space-y-4">
        ...
        <div className="p-3.5 rounded bg-[#25D366]/10 border border-[#25D366]/30 space-y-2">
          <div className="flex items-center justify-between">
            <label className="block text-xs font-sans text-[#25D366] font-semibold uppercase tracking-wider flex items-center gap-1.5">
              ...
              <span>WhatsApp Direct Button Link</span>
            </label>
            {data.whatsappUrl && (
              <a
                ...
                className="text-[11px] text-[#25D366] underline hover:text-white transition-colors"
              >
                Test Link ↗
              </a>
            )}
          ...
          <input
            type="url"
            value={data.whatsappUrl || 'https://wa.me/2348165462205'}
            onChange={(e) => setData({ ...data, whatsappUrl: e.target.value })}
            placeholder="https://wa.me/2348165462205"
            className="w-full px-4 py-2.5 rounded-sm bg-[#141414] border border-[#25D366]/40 text-xs font-sans text-white focus:outline-none focus:border-[#25D366]"
          />
          <p className="text-[11px] text-[#F5F1EA]/60 font-sans">
            This controls all WhatsApp "Hire Me" buttons on the website and in the contact section.
          </p>
        </div>
